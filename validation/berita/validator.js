...
const create = [
    ...
    check('kategori').isIn(['perkembanganKomunitas', 'perkembanganCML', 'GIST']).withMessage('Kategori harus menjadi salah satu dari "perkembanganKomunitas" atau "perkembanganCML" atau "GIST"'),
];
...
const update = [
    ...
    check('kategori').optional().isIn(['perkembanganKomunitas', 'perkembanganCML', 'GIST']).withMessage('Kategori harus menjadi salah satu dari "perkembanganKomunitas" atau "perkembanganCML" atau "GIST'),
];
