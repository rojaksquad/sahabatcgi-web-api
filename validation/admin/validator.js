...
const login = [
    check('email').isString().withMessage('Email harus ber-tipe data String').isLength({ min: 1 }).withMessage('Email tidak boleh kosong'),
...
const update = [
    check('email').optional().isString().withMessage('Email harus ber-tipe data String').isLength({ min: 1 }).withMessage('Email tidak boleh kosong'),
